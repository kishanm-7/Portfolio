        ...
        <section className="h-screen w-full flex flex-col justify-center relative overflow-hidden bg-dark">
            ...
            <div className="absolute top-20 w-full opacity-10 z-0 pointer-events-none select-none">
                <Marquee gradient={false} speed={50} direction="left" autoFill>
                    <span className="text-5xl md:text-[8rem] font-bold uppercase mr-10 md:mr-20 font-heading">Creative Developer</span>
                    <span className="text-5xl md:text-[8rem] font-bold uppercase mr-10 md:mr-20 font-heading">Tech Enthusiast</span>
                    <span className="text-5xl md:text-[8rem] font-bold uppercase mr-10 md:mr-20 font-heading">Minimalist</span>
                </Marquee>
            </div>
            ...
            <div className="max-w-7xl mx-auto w-full z-10 px-6 md:px-20 relative">
                ...
                <div className="overflow-hidden">
                    <motion.h1
                        ...
                        className="text-5xl md:text-[10rem] font-bold leading-[0.85] tracking-tighter mb-2 font-heading"
                    >
                        CREATIVE
                    </motion.h1>
                </div>
                ...
                <div className="overflow-hidden">
                    <motion.h1
                        ...
                        className="text-5xl md:text-[10rem] font-bold leading-[0.85] tracking-tighter mb-8 font-heading"
                    >
                        DEVELOPER
                    </motion.h1>
                </div>
            ...
            <motion.div
                ...
                className="absolute bottom-10 right-4 md:right-20 flex flex-col items-center gap-4 z-20"
            >
